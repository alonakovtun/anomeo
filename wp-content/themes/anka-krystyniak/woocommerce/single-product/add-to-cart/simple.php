...
<?php else : ?>
	<div class="ak-product__add-to-cart-form">
		<button type="submit" class="single_add_to_cart_button button disabled"><?php echo __('Out of stock', 'woocommerce'); ?><span class="price"><?= $product->get_price_html(); ?></span></button>
	</div>
