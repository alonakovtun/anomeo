...
<div class="woocommerce-shipping-fields">
	<?php if (true === WC()->cart->needs_shipping_address()) : ?>
		...
		<h3 id="ship-to-different-address" class="ak-checkout-form__section-title ak-checkout-form__section-title--border-top">
...
<div class="woocommerce-invoice-fields">
	<h3 id="invoice-fields-title" class="ak-checkout-form__section-title ak-checkout-form__section-title--dropdown">
		<? _e('Invoice data (optional)', 'anka-krystyniak'); ?>
	</h3>
