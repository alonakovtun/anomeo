...
<div class="ak-page__title-row">
	<h1 class="title">
		<? _e('Reset password', 'anka-krystyniak'); ?>
	</h1>
</div>

<div class="ak-customer-reset-password-form-container">
	<form method="post" class="ak-customer-reset-password-form lost_reset_password">
		...
		<div class="submit-row">
			...
			<button type="submit" class="form-submit-btn button" value="<?php esc_attr_e('Save', 'woocommerce'); ?>"><?php esc_html_e('Save', 'woocommerce'); ?></button>
		</div>
