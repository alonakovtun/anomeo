...
{
    if (WC()->cart->is_empty()) {
        return '<a class="desktop-menu-btn icon icon-cart" id="cart-popup-toggle " href=""></a>';
    } else {
        return '<a class="desktop-menu-btn icon icon-cart" id="cart-popup-toggle" href=""><p>' . WC()->cart->cart_contents_count . '</p></a>';
    }
}
