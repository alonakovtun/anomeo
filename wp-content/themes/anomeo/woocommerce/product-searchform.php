...
<div class="search_left">
	<input type="search" id="woocommerce-product-search-field-<?php echo isset($index) ? absint($index) : 0; ?>" class="search-field" placeholder="<?php echo esc_attr__('Enter your request', 'anomeo'); ?>" value="<?php echo get_search_query(); ?>" name="s" />
...
<? if (have_rows('search_suggestions_items', 'option')) : ?>
	<div class="search-form__suggestions">
		<p class="title"><? _e('Suggested', 'anomeo'); ?>:</p>
