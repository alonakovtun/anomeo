...
<form class="ak-form ak-form--login" method="post">
    ...
    <div class="lost_password">
        <span><?php esc_html_e('Don’t have an account?', 'anomeo'); ?><a class="register" href="<?= get_permalink(get_option('woocommerce_myaccount_page_id')); ?>"><?php esc_html_e(' Register', 'anomeo'); ?></a></span>
